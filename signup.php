        ...
        <div class="centered-container">
            ...
            <form class="row g-3" method="POST" action="signup.php">
                ...
                <div class="col-md-6">
                    ...
                    <input type="password" class="form-control" id="inputPassword4" name="password" placeholder="Ilovetorentvideos123" required>
                </div>
                <div class="col-md-6">
                    <label for="inputEmail4" class="form-label">Email</label>
                    <input type="email" class="form-control" id="inputEmail4" name="email" placeholder="someone@domain.com" required>
                </div>
                <div class="col-md-4">
